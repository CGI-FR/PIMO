...
${indent(output, 8)}
    ...
    var aDownloadVenomTest = document.createElement("a");
    aDownloadVenomTest.setAttribute("href", `data:text/yaml,${encodedString}`);
    aDownloadVenomTest.setAttribute("download", "test-venom.yml");
    aDownloadVenomTest.click();
    aDownloadVenomTest.remove();
});
