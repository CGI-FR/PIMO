...
`version` is the version of the masking file, it is optional.  
...
In case two types of mask are entered in the same selector, the program can't extract the masking configuration and will return an error.
