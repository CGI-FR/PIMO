...
* `--mask` Declare a simple masking definition in command line (minified YAML format: `--mask "value=[{fluxUri: 'pimo://nameFR'}]"`). Only for the simpliest use case: if caches needed, `masking.yml` definition will be privileged.
