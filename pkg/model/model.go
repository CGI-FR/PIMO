...
type RandomChoiceInCSVType struct {
	...
	TrimLeadingSpace bool   `yaml:"trim,omitempty" json:"trim,omitempty" jsonschema_description:"If true leading white space in a field is ignored"`
}
...
type MaskType struct {
	...
	RandomChoiceInCSV RandomChoiceInCSVType `yaml:"randomChoiceInCSV,omitempty" json:"randomChoiceInCSV,omitempty" jsonschema:"oneof_required=randomChoiceInCSV,title=Random Choice in CSV" jsonschema_description:"Replace the input value with a record chosen randomly from an external CSV resource"`
