...
type Function struct {
	...
	Returns string  `yaml:"returns" jsonschema_description:"Declare return type of function"`
...
type Param struct {
	...
	Type string `yaml:"type" jsonschema_description:"Declare type parameters"`
}
