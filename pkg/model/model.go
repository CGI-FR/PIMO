...
type MaskType struct {
	...
	Permute           bool                 `yaml:"permute,omitempty" jsonschema:"oneof_required=Permute,title=Permute Mask" jsonschema_description:"Shuffle value with values from other records"`
}
